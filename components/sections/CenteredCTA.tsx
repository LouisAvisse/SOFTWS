        ...
        <div className="max-w-content mx-auto px-6 relative text-center">
          ...
          {subheadline && (
            <motion.p
              ...
              className="text-base lg:text-lg leading-snug mb-8 max-w-xl mx-auto text-faint"
            >
              {subheadline}
            </motion.p>
          )}
      ...
      <div className="max-w-content mx-auto px-6 text-center">
        ...
        {subheadline && (
          <motion.p
            ...
            animate={inView ? { opacity: 1, y: 0 } : {}}
            transition={{ duration: 0.5, ease: [0.16, 1, 0.3, 1], delay: subDelay }}
            className={cn('text-base lg:text-lg leading-snug mb-8 max-w-xl mx-auto', isDark ? 'text-faint' : 'text-body')}
          >
            {subheadline}
          </motion.p>
        )}
